...
<<groups, echo=FALSE, dependson='groupsdata', fig.width=10, fig.height=7.5, out.width='\\columnwidth'>>=
...
<<vandals, dependson='vandalsdata', echo=FALSE, results='hide', fig.keep=FALSE, fig.width=11, fig.height=6>>=
