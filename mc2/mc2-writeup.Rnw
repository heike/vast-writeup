...
qplot(dmin/60, Freq, data=subset(domni, id=="others"), geom=c("point", "line"), colour=I("grey60")) +
  ...
  theme(legend.justification=c(1,1), legend.position=c(0.4,0.32.5), plot.margin=unit(c(0,0,0,0), units="cm")) +
...
\begin{figure}
<<x38, echo=FALSE, fig.width=7, fig.height=4, out.width='\\columnwidth'>>=
