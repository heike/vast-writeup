...
\keywords{Spatio-temporal visualizations; Barcode plot; Enhanced map plots.}
...
%% Uncomment below to include a teaser figure.
   \teaser{
    \centering
    \includegraphics[width=.65\linewidth]{figure/omni-1.pdf}
...
The spikes at 10~am, 11~am, 3~pm and 4~pm are all related to Scott Jones sightings, who makes his way from the East entrance entering  Kiddie Land to Grinosaurus Stage in the Coaster Alley.
